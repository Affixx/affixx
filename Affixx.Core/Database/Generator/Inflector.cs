...
namespace Affixx.Core.Database.Generator
{
	...
	/// (Pluralizer, courtesy of Scott Chambers, https://github.com/schambers/fluentmigrator/tree/master/src/FluentMigrator.T4)
	/// </summary>
	public static class Inflector
	{
		...
		static Inflector()
		{
            ...
            AddIrregularRule("bonus", "bonuses");
			...
			AddUnknownCountRule("_DbVersion");
		...
		{
			return Regex.Replace(ToHumanCase(AddUnderscores(word)), @"\b([a-z])", match => match.Captures[0].Value.ToUpper());
		}
